...
if __name__ == '__main__':
    ...
    class Strategy(Piped):
        ...
        def configure(self, cluster):
            ...
            # - update the resulting connection string into /opt/cleaner.portal
            # - this will be used by the cleaner find dead pods and remove
            #
            with open('/opt/cleaner/.portal', 'w') as f:
                f.write(cluster.grep('portal', 9000))
            
            return 'python -u cleaner.py', {}
